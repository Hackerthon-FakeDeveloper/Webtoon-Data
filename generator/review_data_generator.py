...
EXCEL_PATH: str = '.\\data\\review_data.xlsx'
...
def generate() -> pd.DataFrame:
    ...
    reviewed = set()
    for _ in range(6):
        for webtoon_seq_index in range(webtoon_num):
            ...
            while (user_seq, webtoon_seq_index) in reviewed:
                user_seq = randint(1, users_num)
            reviewed.add((user_seq, webtoon_seq_index))
